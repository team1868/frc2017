#ifndef SRC_AUTO_COMMANDS_ALIGNWITHHIGHGOALCOMMAND_H_
#define SRC_AUTO_COMMANDS_ALIGNWITHHIGHGOALCOMMAND_H_
...
public:
	 ...
	 */
	AlignWithHighGoalCommand(RobotModel *robot, NavXPIDSource *navXSource, TalonEncoderPIDSource *talonSource);
	...
	void RefreshIni();
	bool IsDone();
	virtual ~AlignWithHighGoalCommand();
...
#endif /* SRC_AUTO_COMMANDS_ALIGNWITHHIGHGOALCOMMAND_H_ */
