#ifndef SRC_AUTO_COMMANDS_PATHCOMMAND_OLD_H_
#define SRC_AUTO_COMMANDS_PATHCOMMAND_OLD_H_
...
class PathCommand_OLD : public AutoCommand {
public:
	 ...
	 */
	PathCommand_OLD(RobotModel *robot, Path path);
	~PathCommand_OLD();
...
#endif /* SRC_AUTO_COMMANDS_PATHCOMMAND_OLD_H_ */
